...
| 孔位 / 位置 | 装配件 | 数量 / 用途 |
| --- | --- | --- |
| 4 mm 孔 | M3×5 土八热熔螺母 | 19 个 |
| 3.2 mm 孔 | M3×8 螺丝 | 10 个 |
| 3.2 mm 孔 | M3×15 螺丝 | 8 个 |
| 后背板 | M3×85 螺丝 | 4 个，用于后背板固定 |
| 后背板滑轨 | 黑色长螺丝 | 用于前方 4 个狗头固定位 |

将热熔螺母安装到 4 mm 孔中，并按上表在 3.2 mm 孔中使用对应规格的 M3 螺丝。最终拧紧前请确认螺丝长度和螺纹啮合长度合适。
